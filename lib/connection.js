...
import { ConnectionError, MemcachedError, ProtocolError } from './errors.js'
...
export class Connection extends EventEmitter {
  ...
  // Writes are corked until the next microtask checkpoint so that pipelined
  // commands issued in the same synchronous block are flushed with one writev.
  #write (payload) {
